  ...
  <div class="container-fluid">
    ...
    <div class="jumbotron banner-header">
      <div class="container">
        <div class="row">
          <h1>Banners</h1>
          <h4>- Att fånga besökarens uppmärksamhet</h4>
          <hr>
        </div>
      </div>
    </div>
    <div class="container banner-info">
      <div class="row col-lg-12">
        ...
        <div class="column col-lg-6 banner-text">
          <p>Med en banner så vill man oftast att besökaren ska uppmärksamma något. Det kan vara exempelvis en pågående kampanj på en produkt. Just banner är det engelska uttrycket för en webbannons vilket är ett mer förklarande ord.</p>
          <br>
          <p>På de allra flesta webbsidor som du besökt har nog haft en eller flera banners. Ta exempelvis Aftonbladets webbsida, hur mycket (banners) reklam är det inte där? Banners är i stora drag en inkomstkälla för företag på nätet. Antingen per klick annonsen genererar eller en fast summa.</p>
        </div>
